...
public class MarsMission {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Use: E (Empty), R (Rocky), X (Impassable), C (Charging), A (Anomaly)");
            ...
            for (int i = 0; i < height; i++) {
                ...
                for (String cell : row) {
                    if (!isValidCellType(cell)) {
                        System.out.printf("Error: Invalid cell type '%s'. Use E, R, X, C, or A.\n", cell);
                        validRow = false;
                        break;
                    }
                }
